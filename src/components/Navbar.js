  ...
  return (
    <nav className="fixed top-0 left-0 w-full h-[80px] flex justify-between items-center Ccontainer py-4 z-[100] transition-transform duration-75">
      ...
      <div className="flex justify-end gap-5 w-52">
        ...
        {/* Search Box  */}
        <div
          className={`absolute  left-0 w-full z-[112] h-full bg-white flex items-center justify-between xs:Ccontainer px-1 overflow-hidden transition-all ease-in-out duration-300 ${
