...
import { Validation } from "./shared/Authentication";
// Toastify Library
    ...
    <div className=" flex flex-col">
      ...
      <div className="h-[35rem] px-2  mt-[85px] flex justify-center">
        <form className="bg-white w-full h-full flex flex-col items-center justify-center py-14">
          <ToastContainer />
          <h1 className="text-[2.5rem] uppercase">SignUp</h1>
          <div className="flex flex-col sm:w-fit w-full items my-10 gap-4">
            ...
            <div className="flex flex-col">
              <div className="flex items-center border-b-[1px] py-1 border-black">
                <input
                  type="text"
                  className="sm:w-[350px] w-full h-9 text-black font-[300] outline-none"
            ...
            <div className="my-4">
              <button
                type="submit"
                className="w-full h-10 bg-Cblue font-[600
